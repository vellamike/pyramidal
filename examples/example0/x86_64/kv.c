...
#define k_revpot k_revpot_kv
 double k_revpot = -12;
#define m_B_F m_B_F_kv
 double m_B_F = 80;
#define m_B_D m_B_D_kv
 double m_B_D = 0;
#define m_B_C m_B_C_kv
 double m_B_C = 0;
#define m_B_B m_B_B_kv
 double m_B_B = 0;
#define m_B_A m_B_A_kv
 double m_B_A = 0.125;
#define m_A_F m_A_F_kv
 double m_A_F = -10;
#define m_A_D m_A_D_kv
 double m_A_D = -10;
#define m_A_C m_A_C_kv
 double m_A_C = -1;
#define m_A_B m_A_B_kv
 double m_A_B = -0.01;
#define m_A_A m_A_A_kv
 double m_A_A = 0.1;
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 kv /home/mike/dev/pyramidal/examples/example0/x86_64/kv.mod\n");
