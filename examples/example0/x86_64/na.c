...
#define h_B_F h_B_F_na
 double h_B_F = -10;
#define h_B_D h_B_D_na
 double h_B_D = -30;
#define h_B_C h_B_C_na
 double h_B_C = 1;
#define h_B_B h_B_B_na
 double h_B_B = 0;
#define h_B_A h_B_A_na
 double h_B_A = 1;
#define h_A_F h_A_F_na
 double h_A_F = 20;
#define h_A_D h_A_D_na
 double h_A_D = 0;
#define h_A_C h_A_C_na
 double h_A_C = 0;
#define h_A_B h_A_B_na
 double h_A_B = 0;
#define h_A_A h_A_A_na
 double h_A_A = 0.07;
#define m_B_F m_B_F_na
 double m_B_F = 18;
#define m_B_D m_B_D_na
 double m_B_D = 0;
#define m_B_C m_B_C_na
 double m_B_C = 0;
#define m_B_B m_B_B_na
 double m_B_B = 0;
#define m_B_A m_B_A_na
 double m_B_A = 4;
#define m_A_F m_A_F_na
 double m_A_F = -10;
#define m_A_D m_A_D_na
 double m_A_D = -25;
#define m_A_C m_A_C_na
 double m_A_C = -1;
#define m_A_B m_A_B_na
 double m_A_B = -0.1;
#define m_A_A m_A_A_na
 double m_A_A = 2.5;
#define na_revpot na_revpot_na
 double na_revpot = 115;
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 na /home/mike/dev/pyramidal/examples/example0/x86_64/na.mod\n");
...
/*CVODE*/
 ...
 static double _mfac_trates, _tmin_trates;
  ...
  double _xi, _tmax;
  static double _sav_m_A_A;
  static double _sav_m_A_B;
  static double _sav_m_A_C;
  static double _sav_m_A_D;
  static double _sav_m_A_F;
  static double _sav_m_B_A;
  static double _sav_m_B_B;
  static double _sav_m_B_C;
  static double _sav_m_B_D;
  static double _sav_m_B_F;
  static double _sav_h_A_A;
  static double _sav_h_A_B;
  static double _sav_h_A_C;
  static double _sav_h_A_D;
  static double _sav_h_A_F;
  if (!usetable) {return;}
  if (_sav_m_A_A != m_A_A) { _maktable = 1;}
  if (_sav_m_A_B != m_A_B) { _maktable = 1;}
  if (_sav_m_A_C != m_A_C) { _maktable = 1;}
  if (_sav_m_A_D != m_A_D) { _maktable = 1;}
  if (_sav_m_A_F != m_A_F) { _maktable = 1;}
  if (_sav_m_B_A != m_B_A) { _maktable = 1;}
  if (_sav_m_B_B != m_B_B) { _maktable = 1;}
  if (_sav_m_B_C != m_B_C) { _maktable = 1;}
  if (_sav_m_B_D != m_B_D) { _maktable = 1;}
  if (_sav_m_B_F != m_B_F) { _maktable = 1;}
  if (_sav_h_A_A != h_A_A) { _maktable = 1;}
  if (_sav_h_A_B != h_A_B) { _maktable = 1;}
  if (_sav_h_A_C != h_A_C) { _maktable = 1;}
  if (_sav_h_A_D != h_A_D) { _maktable = 1;}
  if (_sav_h_A_F != h_A_F) { _maktable = 1;}
...
static int  rates ( _p, _ppvar, _thread, _nt, _lvm ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
 ...
 _la = trap0 ( _threadargscomma_ _lvm , m_A_A , m_A_B , m_A_C , m_A_D , m_A_F ) ;
   ...
   mtau = 1.0 / ( _la + _lb ) ;
   minf = _la / ( _la + _lb ) ;
   _la = trap0 ( _threadargscomma_ _lvm , h_A_A , h_A_B , h_A_C , h_A_D , h_A_F ) ;
   _lb = trap0 ( _threadargscomma_ _lvm , h_B_A , h_B_B , h_B_C , h_B_D , h_B_F ) ;
   htau = 1.0 / ( _la + _lb ) ;
   hinf = _la / ( _la + _lb ) ;
    return 0; }
